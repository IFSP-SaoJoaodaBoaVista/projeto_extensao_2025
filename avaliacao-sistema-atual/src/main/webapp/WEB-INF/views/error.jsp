...
<head>
    ...
    <style>
        ...
        .header { background-color: #dc3545; color: white; padding: 20px; margin-bottom: 20px; text-align: center; border-radius: 8px; }
        ...
        .error-message { font-size: 18px; color: #495057; margin: 20px 0; }
        .error-details { background: #f8f9fa; padding: 15px; border-radius: 4px; margin: 20px 0; text-align: left; }
